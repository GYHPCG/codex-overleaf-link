<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-2.3.6-blue" alt="版本">
...
| 操作 | 命令 |
|------|------|
| 安装 / 恢复 / 迁移 | `npm exec --yes codex-overleaf-link@2.3.6 -- install-managed` |
| 诊断 | `npm exec --yes codex-overleaf-link@2.3.6 -- doctor` |
| 卸载 | `npm exec --yes codex-overleaf-link@2.3.6 -- uninstall-managed` |
...
- `codex-overleaf-link-2.3.6.tgz`：提供固定版本安装、doctor 诊断和卸载流程的 npm CLI 包。
...
| 安装 / 更新命令 | `npm exec --yes codex-overleaf-link@2.3.6 -- install-managed` | `npm exec --yes codex-overleaf-link@2.3.6 -- install-managed` | `npm exec --yes codex-overleaf-link@2.3.6 -- install-managed` | `npm exec --yes codex-overleaf-link@2.3.6 -- install-managed --browser chromium` |
| 卸载命令 | `npm exec --yes codex-overleaf-link@2.3.6 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.3.6 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.3.6 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.3.6 -- uninstall-managed --browser chromium` |
