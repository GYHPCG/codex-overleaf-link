(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      recentProjects_sessions_action: 'View runs',
      recentProjects_sessions_action_open: 'Hide runs',
      recentProjects_clearProject: 'Delete all sessions for this project',
      ...
      recentProjects_badge_interrupted: 'interrupted',
      recentProjects_badge_stale: 'stale',
    ...
    zh: {
      ...
      recentProjects_sessions_action: '查看会话',
      recentProjects_sessions_action_open: '收起会话',
      recentProjects_clearProject: '删除该项目的全部会话',
      ...
      recentProjects_badge_interrupted: '已中断',
      recentProjects_badge_stale: '久未处理',
